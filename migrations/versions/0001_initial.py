...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("integration_type", sa.Enum("api", "rpa", "manual", name="integration_type", create_type=False), nullable=False),
        sa.Column("two_fa_method",    sa.Enum("totp", "email", "sms", "none", name="two_fa_method", create_type=False), server_default="none"),
    ...
    op.create_table(
        ...
        sa.Column("type",             sa.Enum("auto", "life", "home", "travel", "business", name="policy_type", create_type=False)),
        sa.Column("item_description", sa.String()),
        sa.Column("status",           sa.Enum("active", "expired", "cancelled", name="policy_status", create_type=False), server_default="active"),
    ...
    op.create_table(
        ...
        sa.Column("type",                sa.Enum("assistance", "glass", "collision", "theft", "fire", "other", name="claim_type", create_type=False)),
        sa.Column("severity",            sa.Enum("simple", "grave", name="claim_severity", create_type=False)),
        sa.Column("status",              sa.Enum("open", "in_progress", "waiting_insurer", "escalated", "closed", name="claim_status", create_type=False), server_default="open"),
    ...
    op.create_table(
        ...
        sa.Column("status",          sa.Enum("pending", "contacted", "confirmed", "refused", "no_response", "lost", name="renewal_status", create_type=False), nullable=False, server_default="pending"),
    ...
    op.create_table(
        ...
        sa.Column("type",       sa.Enum("claim", "onboarding", "renewal", "faq", "support", name="conversation_type", create_type=False)),
        sa.Column("status",     sa.Enum("active", "waiting_client", "waiting_insurer", "escalated", "closed", name="conversation_status", create_type=False), server_default="active"),
    ...
    op.create_table(
        ...
        sa.Column("status",          sa.Enum("pending", "nfse_emitted", "nfse_failed", name="commission_status", create_type=False), server_default="pending"),
